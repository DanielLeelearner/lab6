...
function recalculate() {
  var durationText = parseInt(duration.innerHTML);
  switch (modelName.innerHTML){
    case "Model XYZ":
...
function changeDuration() {
  var newDuration = parseInt(prompt("Enter a new duration:"));
  while (true) {
    ...
    newDuration = parseInt(prompt("Enter a valid duration:"));
    }
  }
}
